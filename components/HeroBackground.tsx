...
export function HeroBackground() {
  ...
  return (
    <div ref={rootRef} className="absolute inset-0 -z-10 overflow-hidden">
      ...
      {/* Layer 0.5 — Subtle 3D wireframe + particle field (WebGL). Mounts
          only on capable, non-reduced-motion, wide-enough viewports; see
          HeroScene3D for the gating logic. Sits below the video/GIF/overlay
          so it reads as ambient depth, not a competing focal point. */}
      <HeroScene3D />
